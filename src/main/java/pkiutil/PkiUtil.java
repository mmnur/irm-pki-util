...
public class PkiUtil
{
			...
			throws IrmCryptographyException
	{
		try {
		    ...
		    generator.initialize(2056);		    
		    KeyPair keyPair = generator.generateKeyPair();
		    return keyPair;
		} catch (NoSuchAlgorithmException e) {
			System.out.println("Error when generating key pair. " + e.getMessage());
			...
			throws IrmCryptographyException
	{
		...
		try {
			...
			System.out.println("Error when rebuilding public key. " + e.getMessage());
			throw new IrmCryptographyException(e);
